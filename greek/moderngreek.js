lat1 = ['u', '`A', '`a', '`E', '`e', '`I', '`i', 'ÍI', 'Íi', 'íi', '`O', '`o', 'ÓO', 'Óo', 'óo', '`Y', '`y', 'II', 'Ii', 'ii', 'OO', 'Oo', 'oo', '`Ī', '`ī', '`Ō', '`ō', 'ay', 'ey', 'iy', 'oy'];
lat2 = ['y', 'Á', 'á', 'É', 'é', 'Í', 'í', 'Ī́', 'Ī́', 'ī́', 'Ó', 'ó', 'Ṓ', 'Ṓ', 'ṓ', 'Ý', 'ý', 'Ī', 'Ī', 'ī', 'Ō', 'Ō', 'ō', 'Ī́', 'ī́', 'Ṓ', 'ṓ', 'au', 'eu', 'iu', 'ou'];
